...
public class PostServiceImpl implements PostService {
  ...
  public PostCreateResponseDto createPost(PostCreateRequestDto postCreateRequestDto, Long userId) {
    ...
    return postConverter.fromDomainToCreateResponseDto(
        ...
        s3ProfileImageUrl,
null);
//        postDomain.getS3ImageUrl() == null
//            ? null
//            : getPostImagePreSignedUrl(postDomain.getS3ImageUrl(), userId, postDomain.getPostId()));
  }

  @Override
  public PostCreateResponseDto addImage(String imageUrl, Long postId) {
    PostDomain postDomain = getPost(postId);
    PostDomain updatedPostDomain = postRepository.save(postConverter.addImage(postDomain, imageUrl));
    InterviewResponseDto interviewResponseDto = getInterviewResponseDtoByDomain(updatedPostDomain.getInterviewDomain());
    OverallEvaluationResponseDto overallEvaluationResponseDto =
    ...
    return postConverter.fromDomainToCreateResponseDto(updatedPostDomain, interviewResponseDto, overallEvaluationResponseDto, s3ProfileImageUrl,
    getPostImagePreSignedUrl(imageUrl, updatedPostDomain.getAuthorDomain().getUserId(), postId)
        );
  }
